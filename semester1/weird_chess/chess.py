...
def chess_puzzle(tura_cords, ferz_cords):
    tura_cords = get_figure_cords(tura_cords)
    ferz_cords = get_figure_cords(ferz_cords)
    delete_lines(tura_cords)
    delete_lines(ferz_cords)
    delete_diagonals(ferz_cords)
